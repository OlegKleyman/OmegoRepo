...
namespace Oleg.Kleyman.Core
{
    ...
    public class XPathFormatter : IClientMessageFormatter
    {
        ...
        /// </summary>
        /// <param name="clientMessageFormatter">The <see cref="IClientMessageFormatter"/> to use with this instance.</param>
        ...
        /// </returns>
        /// <param name="message">The inbound message.</param><param name="parameters">Any out values.</param>
