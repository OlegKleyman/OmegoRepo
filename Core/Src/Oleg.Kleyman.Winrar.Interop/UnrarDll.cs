...
namespace Oleg.Kleyman.Winrar.Interop
{
    public class UnrarDll : IUnrarDll
    {
        ...
        /// <remarks>If destName parameter is defined the it overrides the destPath parameter.</remarks>
        ...
        /// <summary>
        /// Closes the handle to the archive. Archive handle must be open to use this method. If it's closed then it fails hard without a
        /// managed exception.
        /// </summary>
        /// <param name="hArcData">The archive handle.</param>
        /// <returns>The success status of the handle closing.</returns>
        /// <remarks>0 if success. If failed returns 17.</remarks>
