...
namespace Oleg.Kleyman.Winrar.Core
{
    ...
    public interface IUnrarWrapper
    {
        ...
        IEnumerable<IFileSystemMember> ExtractAll(IntPtr handle, IFileSystemMemberFactory factory, string destinationPath);

        ArchiveMember GetNextMember(IntPtr handle);
    }
}