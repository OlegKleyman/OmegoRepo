...
namespace Oleg.Kleyman.Utorrent.Core.Tests
{
    ...
    public class TorrentFileTests : TestsBase
    {
        ...
        [Test]
        [ExpectedException(typeof(InvalidCastException), ExpectedMessage = "Unable to convert a 0 length array.", MatchType = MessageMatch.Exact)]
        ...
        [Test]
        [ExpectedException(typeof(InvalidCastException), ExpectedMessage = "First element containing Name is null.", MatchType = MessageMatch.Exact)]
