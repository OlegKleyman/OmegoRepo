...
namespace Oleg.Kleyman.Core.Tests.Integration
{
    ...
    public class FileSystemTests : TestsBase
    {
        ...
        public void GetDirectoryFileStructureTest()
        {
            ...
            var structure = fileSystem.GetDirectoryFileStructure(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration");
            
            var paths = new string[9];
            paths[0] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\Test");
            paths[1] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\Test\SecondLevel1");
            paths[2] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\Test\SecondLevel1\testFile.txt");
            paths[3] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\Test\testFile.txt");
            paths[4] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\Test1");
            paths[5] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\Test1\SecondLevel1");
            paths[6] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\Test1\SecondLevel1\testFile.txt");
            paths[7] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\Test1\SecondLevel1\ThirdLevel1");
            paths[8] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\Test1\SecondLevel2");
        ...
        public void GetDirectoriesTest()
        {
            ...
            var directories = fileSystem.GetDirectories(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration");
        ...
        public void GetDirectoryTreeTest()
        {
            ...
            var directories = fileSystem.GetDirectoryTree(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration");
            var paths = new string[6];
            paths[0] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\Test");
            paths[1] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\Test\SecondLevel1");
            paths[2] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\Test1");
            paths[3] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\Test1\SecondLevel1");
            paths[4] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\Test1\SecondLevel1\ThirdLevel1");
            paths[5] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\Test1\SecondLevel2");
        ...
        public void GetFilesTest()
        {
            ...
            var paths = new string[2];
            paths[0] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\testFile.rar");
            paths[1] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\testFile.txt");
        ...
        public void GetFileTreeTest()
        {
            ...
            paths[0] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\Test\testFile.txt");
            paths[1] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\Test\SecondLevel1\testFile.txt");
            paths[2] = Path.GetFullPath(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Core.Tests.Integration\Test1\SecondLevel1\testFile.txt");
