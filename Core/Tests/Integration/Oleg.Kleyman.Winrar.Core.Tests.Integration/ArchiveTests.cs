...
namespace Oleg.Kleyman.Winrar.Core.Tests.Integration
{
    ...
    public class ArchiveTests : TestsBase
    {
        ...
        {
            Handle.RarFilePath = @"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Winrar.Core.Tests.Integration\TestFolder.rar";
            IArchive archive;
            using (Handle)
            {
            ...
            Assert.AreEqual("..\\..\\..\\..\\..\\..\\Common\\Test\\Oleg.Kleyman.Winrar.Core.Tests.Integration\\TestFolder.rar", archive.Files[0].Volume);
            ...
            Assert.AreEqual("..\\..\\..\\..\\..\\..\\Common\\Test\\Oleg.Kleyman.Winrar.Core.Tests.Integration\\TestFolder.rar", archive.Files[1].Volume);
            ...
            Assert.AreEqual("..\\..\\..\\..\\..\\..\\Common\\Test\\Oleg.Kleyman.Winrar.Core.Tests.Integration\\TestFolder.rar", archive.Files[2].Volume);
            ...
            Assert.AreEqual("..\\..\\..\\..\\..\\..\\Common\\Test\\Oleg.Kleyman.Winrar.Core.Tests.Integration\\TestFolder.rar", archive.Files[3].Volume);
        }
        ...
        public void ExtractTest()
        {
            ...
            using (Handle)
            {
                ...
                extractedMembers = archive.Extract(@"..\..\..\..\..\..\Common\Test\Oleg.Kleyman.Winrar.Core.Tests.Integration\Testing");
            }
            ...
            Assert.AreEqual("C:\\GitRepos\\MainDefault\\Common\\Test\\Oleg.Kleyman.Winrar.Core.Tests.Integration\\Testing\\TestFolder\\testFile.txt", extractedMembers[0].FullName);

            Assert.AreEqual(FileAttributes.Archive, extractedMembers[1].Attributes);
            Assert.IsTrue(extractedMembers[1].Exists);
            Assert.AreEqual("C:\\GitRepos\\MainDefault\\Common\\Test\\Oleg.Kleyman.Winrar.Core.Tests.Integration\\Testing\\test.txt", extractedMembers[1].FullName);

            Assert.AreEqual(FileAttributes.Directory, extractedMembers[2].Attributes);
            Assert.IsTrue(extractedMembers[2].Exists);
            Assert.AreEqual("C:\\GitRepos\\MainDefault\\Common\\Test\\Oleg.Kleyman.Winrar.Core.Tests.Integration\\Testing\\TestFolder\\InnerTestFolder", extractedMembers[2].FullName);

            Assert.AreEqual(FileAttributes.Directory, extractedMembers[3].Attributes);
            Assert.IsTrue(extractedMembers[3].Exists);
            Assert.AreEqual("C:\\GitRepos\\MainDefault\\Common\\Test\\Oleg.Kleyman.Winrar.Core.Tests.Integration\\Testing\\TestFolder", extractedMembers[3].FullName);
